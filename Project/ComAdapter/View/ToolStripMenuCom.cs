...
{
    public class ToolStripMenuCom : TSM
    {
        #region Attributes
        ...
        private RibbonPanel _panelSlack;
        private RibbonButton _slackManage;
        private RibbonButton _slackConnection;
        private RibbonButton _slackContact;
        private RibbonButton _slackSettings;
        ...
        #region Constructor
        public ToolStripMenuCom(InterfaceCommunication intCom)
        {
            _intCom = intCom;
            Init();
        }
        ...
        private void Init()
        {
            ...
            BuildPanelMailBox();
            BuildPanelSlack();
            this.Text = GetText.Text("Communication");
        }
        ...
        private void BuildPanelMailBox()
        {
            ...
            _mailBoxConnection.Name = "Mail_Connection";
            _mailBoxConnection.Text = GetText.Text(_mailBoxConnection.Name.Replace("Mail_", string.Empty));
            _mailBoxConnection.ToolTip = GetText.Text(_mailBoxConnection.Name.Replace("Mail_", string.Empty));
            ...
            _mailBoxSetting.Name = "Mail_Setting";
            _mailBoxSetting.Text = GetText.Text(_mailBoxSetting.Name.Replace("Mail_", string.Empty));
            _mailBoxSetting.ToolTip = GetText.Text(_mailBoxSetting.Name.Replace("Mail_", string.Empty));
            ...
            _mailBoxInbox.Name = "Mail_Inbox";
            _mailBoxInbox.Text = GetText.Text(_mailBoxInbox.Name.Replace("Mail_", string.Empty));
            _mailBoxInbox.ToolTip = GetText.Text(_mailBoxInbox.Name.Replace("Mail_", string.Empty));
        ...
        private void BuildPanelSlack()
        {
            _slackManage = new RibbonButton();
            _slackManage.Name = "Slack_Manage";
            _slackManage.Text = GetText.Text(_slackManage.Name.Replace("Slack_", string.Empty));
            _slackManage.ToolTip = GetText.Text(_slackManage.Name.Replace("Slack_", string.Empty));
            _slackManage.Click += new EventHandler(tsb_Click);
            _slackManage.Image = Properties.Resources.slack;
            _slackManage.SmallImage = Properties.Resources.slack;
            _slackManage.MinSizeMode = RibbonElementSizeMode.Large;

            _slackConnection = new RibbonButton();
            _slackConnection.Name = "Slack_Connection";
            _slackConnection.Text = GetText.Text(_slackConnection.Name.Replace("Slack_", string.Empty));
            _slackConnection.ToolTip = GetText.Text(_slackConnection.Name.Replace("Slack_", string.Empty));
            _slackConnection.Click += new EventHandler(tsb_Click);
            _slackConnection.Image = Tools4Libraries.Resources.ResourceIconSet16Default.connect;
            _slackConnection.SmallImage = Tools4Libraries.Resources.ResourceIconSet16Default.connect;
            _slackConnection.MaxSizeMode = RibbonElementSizeMode.Medium;

            _slackContact = new RibbonButton();
            _slackContact.Name = "Slack_Contacts";
            _slackContact.Text = GetText.Text(_slackContact.Name.Replace("Slack_", string.Empty));
            _slackContact.ToolTip = GetText.Text(_slackContact.Name.Replace("Slack_", string.Empty));
            _slackContact.Click += new EventHandler(tsb_Click);
            _slackContact.Image = Tools4Libraries.Resources.ResourceIconSet16Default.drive_user;
            _slackContact.SmallImage = Tools4Libraries.Resources.ResourceIconSet16Default.drive_user;
            _slackContact.MaxSizeMode = RibbonElementSizeMode.Medium;

            _slackSettings = new RibbonButton();
            _slackSettings.Name = "Slack_Settings";
            _slackSettings.Text = GetText.Text(_slackSettings.Name.Replace("Slack_", string.Empty));
            _slackSettings.ToolTip = GetText.Text(_slackSettings.Name.Replace("Slack_", string.Empty));
            _slackSettings.Click += new EventHandler(tsb_Click);
            _slackSettings.Image = Tools4Libraries.Resources.ResourceIconSet16Default.setting_tools;
            _slackSettings.SmallImage = Tools4Libraries.Resources.ResourceIconSet16Default.setting_tools;
            _slackSettings.MaxSizeMode = RibbonElementSizeMode.Medium;

            _panelSlack = new RibbonPanel();
            _panelSlack.Name = "Slack";
            _panelSlack.Text = GetText.Text(_panelSlack.Name);
            _panelSlack.Items.Add(_slackManage);
            _panelSlack.Items.Add(_slackConnection);
            _panelSlack.Items.Add(_slackContact);
            _panelSlack.Items.Add(_slackSettings);
            this.Panels.Add(_panelSlack);
        }
        #endregion
