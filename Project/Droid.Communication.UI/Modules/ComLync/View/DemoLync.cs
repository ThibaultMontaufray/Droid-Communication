namespace Droid.Communication
{
    ...
    public partial class DemoLync : Form
    {
        ...
        public DemoLync()
        {
            ...
            //Droid.TOBI.TobiInterface.MessageUpdated += new Droid.TOBI.TobiInterfaceEventHandler(TobiInterface_MessageUpdated);
        ...
        {
            //Droid.TOBI.TobiInterface.Ask(text);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.mapPanel1 = new Droid.Communication.MapPanel();
