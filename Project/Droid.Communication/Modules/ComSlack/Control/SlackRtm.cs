...
//        private WebSocket webSocket; // IWebSocketConnection 
...
//        public bool Connected { get { return webSocket.State == WebSocketState.Open; } }//IsOpen; } }
...
//        }
//        public SlackRtm(SlackAdapter adapter)
//        {
//            _adapter = adapter;
//            OnAck += Slack_OnAck;
//            JsonConverter = new SlackJsonConverter(this);
...
//        public bool Connect()
//        {
//            if (String.IsNullOrEmpty(_adapter.Token?.Key))
//            {
//                if (!string.IsNullOrEmpty(_adapter.Token.Key))
//                    Init();
//                else
...
//            if (webSocket != null)
//            {
//                webSocket.CloseAsync(WebSocketCloseStatus.NormalClosure, "end connection", );// Close();
...
//            }
//        }
//        public bool SendMessage(Channel chan, string text, params object[] args)
//        {
//            if (Connect())
//            {
...
//            var query = "token=" + _adapter.Token.Key;
