namespace Droid.Translate
{
    ...
    public partial class TranslateFrenchTunisian : Form
    {
        ...
        private void Translate()
        {
            ...
            //string ret = Droid.Web.Web.TrimPage(string.Format(_url, comboBoxLang.Text.ToUpper(), textBoxIn.Text), "<table class=\"traductions\">", "</table>");
        ...
        {
            Droid.litterature.Sentense s = new Droid.litterature.Sentense("bonjour je m'appelle Andrew");
        }
        #endregion
