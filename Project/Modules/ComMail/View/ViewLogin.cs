...
namespace Droid.Communication
{
    ...
    public partial class ViewLogin : UserControlCustom
    {
        #region Attributes
        ...
        public ViewLogin(EmailAdapter intEmail)
        {
            InitializeComponent();
            _intEmail = intEmail;
        ...
        private void Init()
        {
            ...
            {
                var client = EmailAdapter.ClientMail.Where(c => c.ImapServer.Equals(_intEmail.CurrentInbox.ClientMail.ImapServer)).ToList()[0];
        ...
        private void LoadClientMail()
        {
            ...
            foreach (var item in EmailAdapter.ClientMail)
            {
